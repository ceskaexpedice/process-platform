...
import static org.ceskaexpedice.processplatform.worker.plugin.executor.PluginStarter.SERR_FILE_KEY;
...
public class TestPluginStarter {
    ...
    public void testStartPlugin1() throws Exception {
        ...
        try (
            ...
            pluginContextFactoryMockedStatic.when(() -> PluginContextFactory.createPluginContext(any())).thenReturn(pluginContextMock);

            System.setProperty(PluginStarter.MAIN_CLASS_KEY, "org.ceskaexpedice.processplatform.testplugin1.TestPlugin1");
            System.setProperty(PluginStarter.PLUGIN_ID_KEY, "testPlugin1");
            System.setProperty(PluginStarter.PROCESS_ID_KEY, "testPlugin1ProcessId");
            ...
            System.setProperty(PLUGIN_PAYLOAD_BASE64_KEY, encodedPayload);
            ...
            System.setProperty(SOUT_FILE_KEY, standardStreamFile.getAbsolutePath());
            System.setProperty(SERR_FILE_KEY, errStreamFile.getAbsolutePath());
