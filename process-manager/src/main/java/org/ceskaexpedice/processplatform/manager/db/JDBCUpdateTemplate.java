...
public class JDBCUpdateTemplate {
    ...
    private void setNullParam(int i, NullObject nObj, PreparedStatement pstm) throws SQLException {
        ...
        if (clz.equals(String.class)) {
            ...
            pstm.setTimestamp(i, (Timestamp) null);
        } else if (clz.equals(Time.class)) {
            pstm.setTime(i, (Time) null);
        } else if (clz.equals(Date.class)) {
            pstm.setDate(i, (Date) null);
    ...
    private void setParam(int i, Object object, PreparedStatement pstm, Connection connection) throws SQLException {
        if (object instanceof String) {
            ...
            pstm.setTimestamp(i, (Timestamp) object);
        } else if (object instanceof Time) {
            pstm.setTime(i, (Time) object);
        } else if (object instanceof Date) {
            pstm.setDate(i, (Date) object);
